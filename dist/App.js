...
function App({}) {
  return /* @__PURE__ */ React.createElement(HashRouter, null, /* @__PURE__ */ React.createElement("div", {
    ...
    path: DEVICE_ROUTE
  }, /* @__PURE__ */ React.createElement(Device, null)), /* @__PURE__ */ React.createElement(Route, null, /* @__PURE__ */ React.createElement(DeviceList, null)))), /* @__PURE__ */ React.createElement(ToastContainer, {
